...
//    }
//    
//    public ActionForward viewAllMultichek(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
//    {
        String target = "loadModalPopupSuccess";
        SelectionPopupDAO selectionPopupDAO = new SelectionPopupDAO();
        SelectionPopupValueObject selectionPopupVO = null;
        ...
        try
        {
            ...
            htmlStr.append("<TD align=center>");
            htmlStr.append("<input name=\"btnSelect\" type=\"button\" class=\"action\" ");
            htmlStr.append(" value=\"Select\" onmouseover=\"javascript:buttonOnMouseOver(this)\" ");
            htmlStr.append(" onmouseout=\"javascript:buttonOnMouseOut(this)\" onclick=\"javascript:onClick_Select();\" ");
            htmlStr.append(" title=\"Select the Record\" > </TD>");
            ...
            htmlStr.append(" BACKGROUND: visible; left:10px\">");
            htmlStr.append("<TABLE id=\"tblDataGrid\"  border=\"1\" cellspacing=\"0\" cellpadding=\"5\" width=100% align=\"center\">");
            htmlStr.append("<TR >");
            columnCaptionArraySize = columnCaptionArray.size();
            if (columnCaptionArray != null && columnCaptionArraySize > 0)
            {
                htmlStr.append("<TH ALIGN=CENTER class=gridHdrTH><INPUT type=\"checkbox\" name=\"allRowSelection\" ");
                htmlStr.append(" onchange=\"Javascript:dataChanged();\" onclick=\"Javascript:onClick_HeaderCheckBox(tblDataGrid.rows.length);\"");
                htmlStr.append(" onmouseover=\"Javascript:this.style.cursor = 'hand';\" onmouseout=\"Javascript:this.style.cursor = 'default';\" ></TH>");
            ...
            if (gridData != null && gridData.size() > 0)
            {
                ...
                for (int rowCount = 0; rowCount < gridDataSize; rowCount++)
                {
                    ...
                    if (record != null && recordSize > 0)
                    {
                        ...
                        htmlStr.append("<TR onmouseover=\"Javascript:this.style.cursor = 'hand';\" onmouseout=\"Javascript:this.style.cursor = 'default';\" ");
//                                htmlStr.append("onClick=\"Javascript:setValues11('");
//                                htmlStr.append(STKGeneral.decodeString(argumentStr, Constant.DECODE_HREF)).append("','");
//                                htmlStr.append(STKGeneral.decodeString(selectionPopupVO.getFormName(), Constant.DECODE_HREF)).append("','");
//                                htmlStr.append(STKGeneral.decodeString(selectionPopupVO.getCntrlName(), Constant.DECODE_HREF)).append("','");
//                                htmlStr.append(STKGeneral.decodeString(selectionPopupVO.getCallParentfunct(), Constant.DECODE_HREF)).append("','");
...
//                                htmlStr.append(Constant.DELIMITER_CARRET).append("')\">");
                                ...
                                htmlStr.append("<TD ALIGN=CENTER class=gridDataTD><INPUT type=\"checkbox\" name=\"singleRowSelection\" ");
                                htmlStr.append(" onchange=\"Javascript:dataChanged();\" onclick=\"javascript:onClick_RowCheckBox(tblDataGrid.rows.length);\" ");
                                htmlStr.append(" onmouseover=\"Javascript:this.style.cursor = 'hand';\" onmouseout=\"Javascript:this.style.cursor = 'default';\" ></TD>");
